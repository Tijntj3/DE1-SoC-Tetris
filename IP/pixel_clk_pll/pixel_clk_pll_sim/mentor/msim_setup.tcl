...
# ----------------------------------------
# If pixel_clk_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 711 linux 2020.12.30.11:37:24
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pixel_clk_pll"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/intelFPGA/20.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pixel_clk_pll.vho"
}
